...
$sql = "SELECT * FROM tbl_bank_exams WHERE category = '$mycategory' AND status = 'Active'";
$result = $conn->query($sql);
...
$sql = "SELECT * FROM tbl_bank_exams WHERE category = '$mycategory' AND status = 'Inactive'";
$result = $conn->query($sql);
