...
<head>
        ...
        <title>PSIS | Send - To - Teacher</title>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>E-learning App</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Submitted</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Send To Teacher</a></li>										
										   ...
										   $sql = "SELECT * FROM tbl_teacher WHERE fname = '$myfname' AND lname = '$mylname'";
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a'; ?> onclick = "return confirm('Delete <?php echo $row['AssessmentTitle']; ?> ?')" <?php print ' href="pages/drop_ex.php?id='.$row['Lesson_id'].'">Delete Assessment</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/send_assessment.php" method="POST" enctype="multipart/form-data">

                                         <div class="form-group">
                                            <label for="exampleInputEmail1">First Name</label>
                                            <input type="text" class="form-control" placeholder="Enter your first name" name="fname" required autocomplete="off">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Last Name</label>
                                            <input type="text" class="form-control" placeholder="Enter your last name" name="lname" required autocomplete="off">
                                        </div>
									
										<div class="form-group">
                                            <label for="exampleInputEmail1">Assessment Title</label>
                                            <input type="text" class="form-control" placeholder="Enter lesson title" name="title" required autocomplete="off">
                                        </div>
