...
?>
 <div class="text-right">
    <button class="btn btn-success"><a href="../admin/pages/<?php echo $target_file; ?>" style="color:white;font-weight:bolder" download>DOWNLOAD</a></button>
 </div>
<br/><br/>
<video width="815" height="415" controls>
    <source src="../admin/pages/<?php echo $target_file; ?>" type="video/mp4">
    <source src="../admin/pages/<?php echo $target_file; ?>" type="video/ogg"> 
</video>
