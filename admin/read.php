            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="./">Home</a></li>
                            <li><a href="recieved.php">Lessons</a></li>
...
<?php 
 ...
 if(isset($_GET['id'])){
    ...
    echo "<h1>You are Reading: " .$title. "</h1>";
...
<div class="container">
	<embed src="pages/<?php echo $target_file; ?>" type="application/pdf" width="1100px" height="800px" />
</div> 
