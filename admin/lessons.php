...
<head>
        ...
        <title>PSIS | E-learning App</title>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Lessons</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Lesson</a></li>										
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a href="pages/make_ex_in.php?id='.$row['Lesson_id'].'">Make Inactive</a>';
											   }else{
											   $st = '<p class="text-danger">INACTIVE</p>'; 
                                               $stl = '<a href="pages/make_ex_ac.php?id='.$row['Lesson_id'].'">Make Active</a>';											   
											   }
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>'.$stl.'</li>
													<li><a href="edit-exam.php?eid='.$row['Lesson_id'].'">Edit Lesson</a></li>
													<li><a href="view-questions.php?eid='.$row['Lesson_id'].'">View Lesson</a></li>
												
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['LessonTitle']; ?> ?')" <?php print ' href="pages/drop_ex.php?id='.$row['Lesson_id'].'">Drop Lesson</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Nothing was found in database.
                                         ...
                                         <form action="pages/add_exam.php" method="POST" enctype="multipart/form-data">
