        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>List of Submitted Assessments</h3>
                                          ...
                                          print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													...
													<li><a href="view-submitted.php?eid='.$row['Lesson_id'].'">View Assessment</a></li>
												
                                                    <li><a'; ?> onclick = "return confirm('Delete <?php echo $row['LessonTitle']; ?> ?')" <?php print ' href="pages/drop_xx.php?id='.$row['Lesson_id'].'">Delete Assessment</a></li>
                                                </ul>
                                            </div></td>
