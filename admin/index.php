...
<head>
    ...
    <body class="page-header-fixed">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-green animated slideInRight">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p class="counter"><?php echo number_format($departments); ?></p>
                                        <span class="info-box-title">CLASSES</span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-red animated bounceInUp">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-purple animated slideInLeft">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p><span class="counter"><?php echo number_format($lesson); ?></span></p>
                                        <span class="info-box-title">LESSONS</span>
                                    </div>
                                    <div class="info-box-icon">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-red animated rotateIn">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                                        <p><span class="counter"><?php echo number_format($examination); ?></span></p>
                                        <span class="info-box-title">CLASS WORKS</span>
                                    </div>
                                    <div class="info-box-icon">
                                        <i class="icon-book-open"></i>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-purple animated jackInTheBox">
                                <div class="panel-body">
                                    <div class="info-box-stats">
						...
						<div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-green animated rollIn">
                                <div class="panel-body">
                                    <div class="info-box-stats">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="panel info-box panel-red animated slideInRight">
                                <div class="panel-body">
                                    <div class="info-box-stats">
        ...
        <script src="../assets/wow/src/WOW.js"></script>
        <script>
            new WOW().init();
        </script>
    </body>
