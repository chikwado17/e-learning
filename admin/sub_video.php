...
$sql = "SELECT * FROM tbl_teacher WHERE Lesson_id = '$lesson_id'";
            ...
            <div class="horizontal-bar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <li class="active"><a href="./" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        ...
                        <li><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Exercises</p></a></li>
                        <li><a href="results.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-certificate"></span><p>Results</p></a></li>
                    </ul>
                </div>
            </div>
...
<?php 
 ...
 if(isset($_GET['id'])){
    ...
    $sql = "SELECT FileLocation FROM tbl_teacher WHERE Lesson_id='$lesson_id'";
    ...
    echo "<h1>You are Watching: " .$title. "</h1>";
       

?>
 <div class="text-right">
    <button class="btn btn-success"><a href="pages/<?php echo $target_file; ?>" style="color:white;font-weight:bolder" download>DOWNLOAD</a></button>
 </div>
<br/><br/>

<video width="815" height="415" controls>
    <source src="pages/<?php echo $target_file; ?>" type="video/mp4">
    <source src="pages/<?php echo $target_file; ?>" type="video/ogg"> 
</video>
