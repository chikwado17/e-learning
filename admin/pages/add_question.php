...
// while($question_id <= 1000000000000000000000000000){
...
// $question_id = sprintf($question_id);
...
if ($result->num_rows > 0) {
 ...
 header("location:../add-questions.php?rp=1185&eid=$examid");
    ...
    $sql = "INSERT INTO tbl_questions (exam_id, type, question, option1, option2, option3, option4, option5, answer,avatar)
