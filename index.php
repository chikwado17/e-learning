                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-4 center">
                            <img width="100px" class="center animated infinite bounce delay-5s" src="./admin/logo.png" alt="">
                            <div class="login-box"> <br/><br/>
                                <a href="./" class="logo-name text-lg text-center">PSIS ONLINE E-Learning PORTAL.</a>
                                <p class="text-center m-t-md bounceInLeft">Please login into your account.</p>
                                ...
                                <p class="text-center m-t-md">&copy; Created By Emmanuel ICT...</p>   
                            </div>
                        </div>
                    </div>
                </div>
